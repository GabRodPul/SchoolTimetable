...
const FormalitiesMobile: React.FC = () => {
  ...
  const [isFormalitiesForm, setFormalitiesFormOpen1] = useState(false);
  const [isFormalitiesDone, setFormalitiesDone] = useState(false);

  const toggleMenu1 = () => {
    setFormalitiesFormOpen1(!isFormalitiesForm);;
  };

  const toggleMenu2 = () => {
    setFormalitiesDone(!isFormalitiesDone);;
  };
      ...
      <div className="formalitiesMobile__content">
        <div className="formalitiesMobile__makeForm">
          <div className="formalitiesMobileForm__title">
            <h2 className='title__Title'>Crear un Trámite</h2>
