...
module.exports = {
  // This is shorter. Let's keep it at the top.
  async down (queryInterface: QueryInterface, Sequelize: typeof DataTypes) {
    // Delete everything in the opposite order that it was inserted.
    [ 
      SessionChangedTable,
      WarningTable,
      SessionTable,
      ...
      GroupTable,
      UserTable,
    ].forEach(async t => await queryInterface.bulkDelete(t.name, {}, {}));
  },

  async up (queryInterface: QueryInterface, Sequelize: typeof DataTypes) {
    await queryInterface.bulkInsert(UserTable.name, [
      {
          id: 1,
          name: "Profe Número 1",
  ...
  await queryInterface.bulkInsert(GroupTable.name, [
      dbgGrp.DAW2M,
      dbgGrp.DAW2T,
      dbgGrp.DAW2N,
      dbgGrp.DAM2M,
  ...
  // Storing these for clearer data creation
  await queryInterface.bulkInsert(ClassHourTable.name, [
      {
          id: 1,
          turn: Turn.Afternoon,
          sessionHour: 1,
  ...
  await queryInterface.bulkInsert(ModuleTable.name, [
      dbgMod.FCT,
      dbgMod.PRW,
      dbgMod.DOR,
      dbgMod.DPL,
  ...
  await queryInterface.bulkInsert(EnrollmentTable.name, [
  ...
  await queryInterface.bulkInsert(IGTModuleTable.name, [
      // 2ºDAW
      // * DOR
  ...
  await queryInterface.bulkInsert(SessionTable.name, [
